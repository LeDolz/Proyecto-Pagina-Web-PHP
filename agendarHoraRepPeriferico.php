...
<html>
    ...
    <body>
        ...
        <h1>
            <p>
                Reparaciones de periféricos
            </p>
        </h1>

        <p class="textoNormal" align="justify">
            En este formulario puedes asignar una hora para llevarnos tu periférico y poder repararlo. <br>
        ...
        <form action="agendarHoraRepPeriferico.php" method="POST">
            <table>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tdContactanos">
                            Mouse
                            <input type="radio" value="Mouse" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Teclado
                            <input type="radio" value="Teclado" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Audífonos
                            <input type="radio" value="Audífonos" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Impresora
                            <input type="radio" value="Impresora" name="tipoDispositivo" style="margin-right: 20px;" required>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdContactanos">
    ...
    if(isset($_POST["enviar"])){
        ...
        @$fecha = $_POST["fecha"];
        @$hora = $_POST["hora"];
        @$servicio = "Reparación periférico";
