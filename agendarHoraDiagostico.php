...
<html>
    <head>
        ...
        <?php  
            class Datos{
                ...
                public function agendarHoraDiag($nombre, $telefono, $tipoDis, $oficina, $fecha, $hora, $tipoServicio, $descripcion){
                    $sql = "call agendarHoraDiag('$nombre', '$telefono', '$tipoDis', '$oficina', '$fecha', '$hora', '$tipoServicio', '$descripcion')";
    ...
    <body>
        ...
        <p class="textoNormal" align="justify">
            En este formulario puedes asignar una hora para que diagnostiquemos y posteriormente arreglemos tu PC. <br>
        ...
        <form action="agendarHoraDiagostico.php" method="POST">
            <table>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td class="tdContactanos">
                            <p>
                                Pequeña descripción del problema<br>(Opcional)
                            </p>
                        </td>
                        <td>
                            <textarea class="textAreaContactanos" name="descripcion"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
    ...
    if(isset($_POST["enviar"])){
        ...
        $op = new Datos();
        $op->agendarHoraDiag($nombre, $numTel, $tipoDisp, $oficina, $fecha, $hora, $servicio, $descripcion);
    }
    ?>
</html>