...
<html>
    ...
    <body>
        ...
        <p class="textoNormal" align="justify">
            En este formulario puedes asignar una hora para realizar un formateo a tu PC y restaurarlo con los valores de fábrica. <br>
        ...
        <form action="agendarHoraFormateo.php" method="POST">
            <table>
                <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td rowspan="4" class="trLogo">
                            <img src="imagenes/logos/logoTienda.png">
                        </td>
                    </tr>
                    <tr>
