...
<html>
    <head>
        ...
        <?php
            class Datos{
                ...
                public function agendarHoraRep($nombre, $telefono, $tipoDis, $oficina, $fecha, $hora, $tipoServicio){
    ...
    <body>
        ...
        <h1>
            <p>
                Reparaciones de piezas grandes
            </p>
        </h1>

        <p class="textoNormal" align="justify">
            En este formulario puedes asignar una hora para llevarnos tu componente y poder repararlo. <br>
        ...
        <form action="agendarHoraRepCompGrande.php" method="POST">
            <table>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tdContactanos">
                            Procesador
                            <input type="radio" value="CPU" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Tarjeta gráfica
                            <input type="radio" value="GPU" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Placa madre
                            <input type="radio" value="Placa madre" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Memoria RAM
                            <input type="radio" value="RAM" name="tipoDispositivo" style="margin-right: 20px;" required>
                            <br>
                            Fuente de poder
                            <input type="radio" value="PSU" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Refrigeracion líquida
                            <input type="radio" value="AIO" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Almacenamiento
                            <input type="radio" value="Almacenamiento" name="tipoDispositivo" style="margin-right: 20px;" required>
    ...
    if(isset($_POST["enviar"])){
        ...
        @$fecha = $_POST["fecha"];
        @$hora = $_POST["hora"];
        @$servicio = "Reparación componente grande";

        $op = new Datos();
        $op->agendarHoraRep($nombre, $numTel, $tipoDisp, $oficina, $fecha, $hora, $servicio);
    }
    ?>
</html>