...
<html>
    ...
    <body>
        ...
        <h1>
            <p>
                Reparaciones de piezas pequeñas
            </p>
        </h1>
        ...
        <form action="agendarHoraRepCompPequenio.php" method="POST">
            <table>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tdContactanos">
                            Ventilador
                            <input type="radio" value="Ventilador" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Tarjeta de red
                            <input type="radio" value="Tarjeta de red" name="tipoDispositivo" style="margin-right: 20px;" required>
                            <br>
                            Puerto de la placa
                            <input type="radio" value="Puerto de la placa" name="tipoDispositivo" style="margin-right: 20px;" required>
                            Unidad óptica
                            <input type="radio" value="Unidad Óptica" name="tipoDispositivo" style="margin-right: 20px;" required>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdContactanos">
    ...
    if(isset($_POST["enviar"])){
        ...
        @$fecha = $_POST["fecha"];
        @$hora = $_POST["hora"];
        @$servicio = "Reparación componente pequeño";
