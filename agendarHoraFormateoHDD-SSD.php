...
<html>
    <head>
        ...
        <?php
            class Datos{
                ...
                public function agendarHoraFormateo($nombre, $telefono, $tipoDis, $oficina, $fecha, $hora, $tipoServicio){
    ...
    <body>
        ...
        <h1>
            <p>
                Restauración de fábrica de HDD o SSD
            </p>
        </h1>

        <p class="textoNormal" align="justify">
            En este formulario puedes asignar una hora para realizar un formateo a tu unidad de almacenamiento y restaurarla. <br>
        ...
        <form action="agendarHoraFormateoHDD-SSD.php" method="POST">
            <table>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tdContactanos">
                            Disco duro
                            <input type="radio" value="HDD" name="tipoDispositivo" style="margin-right: 20px;" required>
                            SSD SATA
                            <input type="radio" value="SSD" name="tipoDispositivo" style="margin-right: 20px;" required>
                            SSD M.2
                            <input type="radio" value="SSD-M.2" name="tipoDispositivo" required>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdContactanos">
    ...
    if(isset($_POST["enviar"])){
        ...
        @$fecha = $_POST["fecha"];
        @$hora = $_POST["hora"];
        @$servicio = "Formateo HDD-SSD";

        $op = new Datos();
        $op->agendarHoraFormateo($nombre, $numTel, $tipoDisp, $oficina, $fecha, $hora, $servicio);
    }
    ?>
</html>